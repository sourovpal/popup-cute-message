...
function cuteAlert({
  ...
  return new Promise((resolve) => {
    ...
    let btnTemplate = `
    <button id="btn_ok" class="alert-button ${type}-bg ${type}-btn">${buttonText}</button>
    `;
    if (type === "question") {
      btnTemplate = `
      <div class="question-buttons">
        <button id="btn_confirm" class="confirm-button ${type}-bg ${type}-btn">${confirmText}</button>
    ...
    <div class="alert-wrapper">
      <div class="alert-frame">
        <div class="alert-header ${type}-bg">
          <span class="${closeStyleTemplate}">&times;</span>
